...
//        }
        ...
        swaps[3] = IBalancerVault.BatchSwapStep(POOL_ID, 1, 0, 10, "");
        swaps[4] = IBalancerVault.BatchSwapStep(POOL_ID, 1, 0, 10, "");
        swaps[5] = IBalancerVault.BatchSwapStep(POOL_ID, 1, 0, 4, "");

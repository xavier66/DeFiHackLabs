...
//            bal_rETH -= amountOut;
//        }
        swaps[0] = IBalancerVault.BatchSwapStep(POOL_ID, 1, 0, bal_rETH -50, "");
        swaps[1] = IBalancerVault.BatchSwapStep(POOL_ID, 1, 0, 24, "");
        swaps[2] = IBalancerVault.BatchSwapStep(POOL_ID, 1, 0, 20, "");

//        swaps[5] = IBalancerVault.BatchSwapStep(POOL_ID, 1, 0, 5, "");
